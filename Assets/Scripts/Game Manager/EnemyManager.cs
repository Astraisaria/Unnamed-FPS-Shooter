...
public class EnemyManager : MonoBehaviour
{
    ...
    public Transform[] cannibal_SpwanPoints, boar_SpawnPoints;
    ...
    void SpawnCannibals(){
        ...
        for (int i = 0; i < cannibal_Enemy_Count; i ++){
            if (index >= cannibal_SpwanPoints.Length){
                index = 0;
            }
            Instantiate(cannibal_Prefab, cannibal_SpwanPoints[index].position, Quaternion.identity).SetActive(true);
    ...
    void SpawnBoars(){
        ...
        for (int i = 0; i < boar_Enemy_Count; i ++){
            ...
            Instantiate(boar_Prefab, boar_SpawnPoints[index].position, Quaternion.identity).SetActive(true);
